...
class SymptomRecognizer(Frame):
    def __init__(self,parent):
        ...
        self.sf = ScrolledFrame(parent, width=1480, height=500)
    ...
    def initUI(self):
        ...
        label0=Label(self.inner_frame,text=" \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t ",font=('Times New Roman',6))
        label0.pack()
        self.sf.pack()
        self.update()
        lable1=Label(self.inner_frame,text='Welcome to Interactive health bot',fg='black',bg='light blue',relief='solid',font={'Times New Roman','42','bold'},pady=5,padx=5)
        ...
        label1a.pack()
        lable22=Label(self.inner_frame, text="Let's measure the body temperature", fg='black',bg='white',font={'times', 18, 'bold'}, anchor='w',pady=1)
        ...
        lable23 = Label(self.inner_frame, text="Current body temperature is: {} F".format(temp), fg='black',bg='light blue',relief='raised',font={'times', 18, 'bold'}, anchor='w')
        ...
        self.engine.runAndWait()
        lable24 = Label(self.inner_frame, text="You have: {}".format(cond.title()), fg='black', bg='white',font={'times', 18, 'bold'}, anchor='w')
    ...
    def ask_symptoms(self):
        while True:
            with sr.Microphone() as source:
                label2=Label(self.inner_frame,text="Please tell your symptoms",fg='black',font={'times',18,'bold'},anchor='w')
                ...
                try:
                    ...
                    display1=Message(self.inner_frame,text=self.text,relief='groove',fg='black',bg='light blue',width=450,font={'Times New Roman',18,'bold'},anchor='w')
    ...
    def check_symptoms(self):
        ...
        def error_condition():
            ...
            lable10=Label(self.inner_frame,text="oops! Looks like we couldn't record any symptoms. Would you want to start over?",fg='black',bg='white',font={'times',18,'bold'},width=300,anchor='w')
            ...
            self.engine.runAndWait()
            print('yes or no?')
            label11=Label(self.inner_frame,text="YES or NO?",fg='black',bg='white',font={'times',18,'bold'},anchor='w')
            y+=40
                ...
                with sr.Microphone() as source:
                    ...
                    try:
                        ...
                        if self.text1.lower()=='yes':
                            ...
                            print("Bye")
                            label18=Label(self.inner_frame,text="Bye!",fg='black',bg='white',font={'times',18,'bold'},anchor='w')
                            y+=40
                            label18.place(x=25,y=y)
        ...
        label1c.pack()
        lable6=Label(self.inner_frame,text="Please confirm your symptoms by saying YES/NO",fg='Black',font={'Times New Roman',18,'bold'},anchor='w',justify=LEFT)
        y+=40
        ...
        while True:
            if self.output==[]:
                ...
                while True:
                    lable7=Label(self.inner_frame,text=self.output[0],fg='black',bg='white',font={'times',18,'bold'},anchor='w')
                        ...
                        try:
                            ...
                            if difflib.get_close_matches(soundex(self.text2),[soundex("yes")]):
                                ...
                                if counter>5:
                                    ...
                                    lable8=Label(self.inner_frame,text="Sorry could not recognize your voice. Please tell again!",fg='black',bg='white',font={'times',18,'bold'},anchor='w')
                            ...
                            lable9=Label(self.inner_frame,text="Sorry could not recognize your voice!",fg='black',bg='white',font={'times',18,'bold'},anchor='w')
    ...
    def display_symptoms(self):
        ...
        if len(self.symptoms)>0:
            ...
            label1d.pack()
            lable13=Label(self.inner_frame,text="Recorded symptoms are:",fg='Black',font={'Times New Roman',18,'bold'},anchor='w')
            ...
            for i in self.symptoms:
                lable14=Label(self.inner_frame,text=i,fg='black',bg='white',font={'times',18,'bold'},anchor='w')
            ...
            print('bye')
            lable15=Label(self.inner_frame,text="Bye",fg='black',bg='white',width=30,font={'times',18,'bold'},anchor='w')
            ...
            self.engine.say("bye")
            self.engine.runAndWait()
        fb = firebase.FirebaseApplication("https://interactive-health-bot-1d344.firebaseio.com/", None)
        whattime = datetime.datetime.now()
        self.symptoms.append(whattime)
        result= fb.post("/ihb-3fc83:/Patient Data", self.symptoms)
    ...
    def classify_symptoms(self):
        ...
        def remaining_syms(model,df,disease,symptoms_covered):
            ...
            gap=Label(self.inner_frame,text="",fg='black',font={'times',18,'bold'},anchor='w')
            ...
            if counter==0:
                ...
                while i<len(d):
                    ...
                    try:
                        if len(d[i+3])<15:
                            lable17=Label(self.inner_frame,text=" {}  | {} | {} | {} ".format(d[i],d[i+1],d[i+2],d[i+3]),fg='black',bg='white',relief='raised',font={'times',18,'bold'})
                            lable17.pack()
                            self.sf.yview_moveto(99999)
                            self.sf.update()
                            self.update()
                            ...
                            lable17=Label(self.inner_frame,text=" {} | {} | {} ".format(d[i],d[i+1],d[i+2]),fg='black',bg='white',relief='raised',font={'times',18,'bold'})
                            lable17.pack()
                            self.sf.yview_moveto(99999)
                            self.sf.update()
                            self.update()
                        ...
                        print(e)                        
                        if i+1==len(d):
                            lable17c=Label(self.inner_frame,text=" {}  ".format(d[i]),fg='black',bg='white',relief='raised',font={'times',18,'bold'})
                            lable17c.pack()
                        elif i+2==len(d):
                            lable17c=Label(self.inner_frame,text=" {} | {} ".format(d[i],d[i+1]),fg='black',bg='white',relief='raised',font={'times',18,'bold'})
                            lable17c.pack()
                        elif i+3==len(d):
                            lable17c=Label(self.inner_frame,text=" {} | {} | {} ".format(d[i],d[i+1],d[i+2]),fg='black',bg='white',relief='raised',font={'times',18,'bold'})
                            lable17c.pack()
                        else:
                            pass
                        self.sf.pack()
            ...
            while(state<4):
                while True:
                    gap1=Label(self.inner_frame,text="",fg='black',font={'times',18,'bold'},anchor='w')
                    ...
                    lable18=Label(self.inner_frame,text="Pick any of the mentioned symptoms that you might be facing, if not tell 'No'" ,fg='black',bg='white',font={'times',18,'bold'},anchor='w')
                ...
                if difflib.get_close_matches(metaphone("no"),[metaphone(self.inp)]):
                    if metaphone("no")[0]==metaphone(self.inp)[0]:
                        if metaphone(self.inp) == 'NS':
                            ...
                            state+=1
                            lable18a=Label(self.inner_frame,text="No",fg='black',bg='light blue',relief='raised',font={'times',18,'bold'},anchor='w')
                ...
                if matched_symp is "":
                    if difflib.get_close_matches(metaphone(self.inp) , ['FLKM','FLM','FLHM','FHLM']) and 'phlegm' in d:
                        matched_symp='phlegm'
                    elif difflib.get_close_matches(metaphone(self.inp) , ['MLS','ML','MLX']) and 'malaise' in d:
                    ...
                    elif difflib.get_close_matches(metaphone(self.inp) , ['FTK','PRTK','FT']) and 'fatiue' in d:
                    #elif difflib.get_close_matches(metaphone(self.inp),['FTK','PRTK']):
                        matched_symp='fatigue'
                    elif difflib.get_close_matches(metaphone(self.inp) , ['XLS','XL','XN','XLT','XR','SLS']) and 'chills' in d:
                        matched_symp='chills'
                if matched_symp is not '':
                    print(matched_symp)
                    lable18b=Label(self.inner_frame,text=matched_symp,fg='black',bg='light blue',relief='raised',font={'times',18,'bold'},anchor='w')
        ...
        def uni_quest(result_list):
            ...
            for n in result_list: 
                ...
                while (state==0):
                    ...
                    print(quest)
                    gap2=Label(self.inner_frame,text="",fg='black',font={'times',18,'bold'},anchor='w')
                   # gap2.place(x=25,y=self.y1)
                    ...
                    sq=Label(self.inner_frame,text=quest,wraplength=500,fg='black',bg='white',font={'times',18,'bold'})
                   # sq.place(x=25,y=self.y1)
                    ...
                    with sr.Microphone() as source:
                        ...
                        try:
                            self.text2=self.recognizer.recognize_google(audio)
                            if difflib.get_close_matches(soundex(self.text2),[soundex("yes")]):
                                ans=Label(self.inner_frame,text="Yes",fg='black',bg='light blue',relief='raised',font={'times',18,'bold'},anchor='w')
                               # ans.place(x=25,y=self.y1)
                                ...
                                ans=Label(self.inner_frame,text="No",fg='black',bg='light blue',relief='raised',font={'times',18,'bold'},anchor='w')
                               # ans.place(x=25,y=self.y1)
                                self.update()
                                ans.pack(side='top')
                                self.sf.pack()
                                ...
                                print("Sorry could not recognize your voice. Please tell again!")
                                lable8a=Label(self.inner_frame,width=70,text="Sorry could not recognize your voice. Please tell again!",fg='black',bg='white',font={'times',18,'bold'},anchor='w')
                            ...
                            print("Sorry could not recognize your voice")
                            lable9a=Label(self.inner_frame,text="Sorry could not recognize your voice!",fg='black',bg='white',font={'times',18,'bold'},anchor='w')
        ...
        while(prob>0.1):
            if prob<=0.75 and calc<4:
                ...
                if remedy=="" and len(res)==1:
                    ...
                    lable26=Label(self.inner_frame,text="\n Sorry could not predict any disease! Would you want to start over?",fg='black',font={'times',18,'bold'},anchor='w')
                    self.update()
                ...
                gap3=Label(self.inner_frame,text="",fg='black',font={'times',18,'bold'},anchor='w')
                ...
                lable21=Label(self.inner_frame,text="The suspected disease is",fg='black',bg='white',font={'times',18,'bold'},anchor='w')
                ...
                self.engine.runAndWait()
                for k in res:
                    lable21=Label(self.inner_frame,text=k,fg='black',bg='light blue',relief='solid',font={'times',18,'bold'},anchor='w')
                    lable21.place(x=25,y=self.y1)
                    self.sf.update()
                    lable21.pack(side='top')
                    self.sf.pack()
                    ...
                    if remedy is not "":                
                        print(remedy)
                        lable25=Label(self.inner_frame,text="The remedy for {} is: {} ".format(k,remedy),wraplength = 500,fg='black',bg='white',font={'times',18,'bold'})
